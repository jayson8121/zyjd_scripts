...
!(async () => {
  ...
  await requestAlgo();
  let res = {}, res2 = await getAuthorShareCode("https://raw.githubusercontent.com/FearNoManButGod/jd_scripts/main/AuthorShareCode/jd_cfd.json")
  if (new Date().getHours() <= 3) res = await getAuthorShareCode('http://cdn.annnibb.me/cfd.jsonhttps://raw.githubusercontent.com/FearNoManButGod/jd_scripts/main/AuthorShareCode/jd_cfd.json');
  if (!res2) res2 = await getAuthorShareCode('https://raw.githubusercontent.com/FearNoManButGod/jd_scripts/main/AuthorShareCode/jd_cfd.json')
