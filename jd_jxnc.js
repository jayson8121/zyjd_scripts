...
function shareCodesFormat() {
  return new Promise(async resolve => {
	...
	AuthorShareCode =  await getAuthorShareCode('https://raw.githubusercontent.com/FearNoManButGod/jd_scripts/main/AuthorShareCode/jd_jxnc.json');
    currentShareCode = [...(AuthorShareCode || [])];
