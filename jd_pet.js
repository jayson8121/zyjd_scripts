...
function getAuthorShareCode(url = "https://raw.githubusercontent.com/FearNoManButGod/jd_scripts/main/AuthorShareCode/jd_pet.json") {
  return new Promise(async resolve => {
   const options = {
...
function shareCodesFormat() {
  return new Promise(async resolve => {
   ...
   /*  newShareCodes = []; */
    AuthorShareCode =  await getAuthorShareCode('https://raw.githubusercontent.com/FearNoManButGod/jd_scripts/main/AuthorShareCode/jd_pet.json');
