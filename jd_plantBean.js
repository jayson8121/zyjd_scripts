...
function shareCodesFormat() {
  return new Promise(async resolve => {
    // console.log(`第${$.index}个京东账号的助力码:::${$.shareCodesArr[$.index - 1]}`)
     AuthorShareCode =  await getAuthorShareCode('https://raw.githubusercontent.com/FearNoManButGod/jd_scripts/main/AuthorShareCode/jd_plantBean.json');
...
//获取助力
function getAuthorShareCode(url = "https://cdn.jsdelivr.net/gh/FearNoManButGod/jd_scripts@main/AuthorShareCode/jd_plantBean.json") {
  return new Promise(async resolve => {
   const options = {
